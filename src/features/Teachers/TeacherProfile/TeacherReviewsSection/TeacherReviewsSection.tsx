...
export default function TeacherReviewsSection({
  ...
  const ratingScore = teacher.rating_avg || 5.0;
  const reviewsCount = teacher.reviews_count || reviews.length;
    ...
    <section className={styles.reviewsSection}>
      <div className="container">
        ...
        <div className={styles.sliderContainer}>
          ...
          >
            {reviews.map((rev, idx) => {
              const studentName = rev.reviewer_name;
              const country = rev.reviewer_country;
                    ...
                    <div className={styles.cardHeader}>
                      <div className={styles.studentInfo}>
                        <div className={styles.avatarLetter}>
                          {rev.initial || studentName.charAt(0)}
                        </div>
                        <div>
